...
import XApeAbi from './abi/xape.json'
...
export class Contracts {
  constructor(provider, networkId, web3, options) {
    ...
    this.ape = new this.web3.eth.Contract(ApeAbi)
    this.masterChef = new this.web3.eth.Contract(MasterChefAbi)
    this.xApeStaking = new this.web3.eth.Contract(XApeAbi)
  ...
  setProvider(provider, networkId) {
    ...
    setProvider(this.ape, contractAddresses.ape[networkId])
    setProvider(this.masterChef, contractAddresses.masterChef[networkId])
    setProvider(this.xApeStaking, contractAddresses.xApe[networkId])
