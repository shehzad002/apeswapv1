    ...
    if (step === 'disclaimer') {
      return (
        <div>
          ...
          <p> Ape will be the home of our new frontend, and provides
              an interface for all interactions with the ApeSwap protocol.
          </p>
          <p> Development will be on going, and apeswap will still
              exist in the interim as we work to get Ape completely
              polished.
          </p>
        </div>
      )
